...
peridynamics. To discretize a material block, users can use PDMesh
(<https://github.com/ravinderbhattoo/PDMesh>) which will provide
...
Figure [1.1](#fig:chap7_para_perf)
...
in Figure [1.1](#fig:chap7_para_perf)
...
Figure [1.3](#fig:chap7_vis_sample). It is a text file with per particle
...
Figure [1.2](#fig:chap7_datafile). Here, line number 1 show the total
...
Figure [1.5](#fig:tensilebar_plots).
Figure [1.4](#fig:tensilebar_fig) shows the time evolution of damage. List
...
<figcaption>Bar showing evolution of damage during tensile load
...
<figcaption>Normal stress vs strain curve for bar simulation under
constant strain rete for a) bond based model and b) ordinary state based
model.</figcaption>
</figure>

As shown in Figure [1.5](#fig:tensilebar_plots), the Young's modulus from simulation
...
Figure [1.7](#fig:flexure_bb).
Figure [1.6](#fig:flexure_fig) shows the time evolution of damage. List of
...
<figcaption>Damage evolution of a bar under flexure load.</figcaption>
</figure>

![Lateral force vs displacement curve for bar under flexure
load.](/images/blogs/peridyn/flexure/flexure_bb_vv.png)

As shown in Figure [1.7](#fig:flexure_bb), the flexural stiffness from simulation is
...
Figure [1.9](#fig:pulse_plot).
Figure [1.8](#fig:wave_fig)  shows the time evolution of normal stress
...
<figcaption>Heatmap of pressure wave propagation for a bar under impulse
load.</figcaption>
</figure>

![Time evolution of normal stress at fixed end of a bar after impulse
load.](/images/blogs/peridyn/pulse/pulse_bb_vv.png)

As shown in Figure [1.9](#fig:pulse_plot), the wave velocity from simulation is close
...
Figure [1.11](#fig:disk_plot).
Figure [1.10](#fig:disk_fig) shows the time evolution of damage. List of
...
<figcaption>Damage evolution of a disk being hit by a
projectile.</figcaption>
</figure>

![Damage evolution of a disk being hit by a
projectile.](/images/blogs/peridyn/disk/damage_disk.png)
